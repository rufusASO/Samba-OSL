 ...
 * @author root
 */
public class AnadirSeccion extends javax.swing.JDialog {

    private String[] datos = new String[5];
    
    /** Creates new form Anadir */
    public AnadirSeccion(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AnadirSeccion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AnadirSeccion dialog = new AnadirSeccion(new javax.swing.JFrame(), true);
